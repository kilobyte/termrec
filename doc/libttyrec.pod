...
=item B<int     open_stream(int >I<fd>B<, char* >I<url>B<, int >I<mode>B<, char **>I<error>B<);>
...
=item B<ttyrec          ttyrec_load(int >I<fd>B<, char *>I<format>B<, char *>I<filename>B<, tty >I<vt>B<);>
...
=item B<ttyrec_frame    ttyrec_seek(ttyrec >I<tr>B<, struct timeval *>I<t>B<, tty *>I<vt>B<);>
