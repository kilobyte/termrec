...
=item termcast:// (e.g. termcast://termcast.org/FooTV)
...
Compatible with a program named B<DosRecorder>.
...
between B<ttyrec> and B<live>.  Caveats about B<live> blasting the whole file
right away apply!
